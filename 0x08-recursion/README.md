...
* **2. Dreams feel real while we're in them. It's only when we wake up tht we reaizesomething as actually strange**
 al w * [2-strlen_recursion.c](./2-strlen_recursion.c): C function that returns the
  length of a string.
